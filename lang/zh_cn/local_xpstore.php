...
$string['topactivities'] = '购买量最多的活动';
$string['toprewardsbypurchases'] = '购买最多的奖励';
$string['toprewardsbyxp'] = '消耗 XP 最多的奖励';
...
$string['type_f'] = '论坛（经典）';
$string['type_g'] = '奖励分';
$string['type_help'] = '选择奖励类型：<br><br><b>额外尝试：</b>适用于测验。<br><b>延期：</b>仅适用于作业。<br><b>论坛（经典）：</b>允许在截止日期后发帖。<br><b>奖励分：</b>直接向成绩单添加额外分数。<br><b>特殊：</b>解锁 VIP 群组中的隐藏内容。<br><b>解锁：</b> 解锁受商店限制的特定活动（需要 XP Store Availability 插件）。';
$string['type_q'] = '额外尝试';
$string['type_s'] = '特殊';
