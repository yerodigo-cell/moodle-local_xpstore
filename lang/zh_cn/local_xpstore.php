...
$string['points'] = '积分';
$string['primarycolor'] = '主色调（卡片和图标）';
$string['privacy:metadata:local_xpstore_gastos'] = '在 XP 商店中存储有关用户兑换的信息。';
$string['privacy:metadata:local_xpstore_gastos:amount'] = '该项目的 XP 成本。';
$string['privacy:metadata:local_xpstore_gastos:itemid'] = '应用兑换的课程模块的 ID。';
$string['privacy:metadata:local_xpstore_gastos:itemtype'] = '兑换项目的类型。';
$string['privacy:metadata:local_xpstore_gastos:timecreated'] = '兑换发生的时间。';
$string['privacy:metadata:local_xpstore_gastos:userid'] = '执行兑换的用户。';
