...
$string['points'] = 'ポイント';
$string['primarycolor'] = 'メインカラー (カード＆アイコン)';
$string['privacy:metadata:local_xpstore_gastos'] = 'XPストアでのユーザーの引き換えに関する情報を保存します。';
$string['privacy:metadata:local_xpstore_gastos:amount'] = 'XPでのアイテムのコスト。';
$string['privacy:metadata:local_xpstore_gastos:itemid'] = '引き換えが適用されたコースモジュールのID。';
$string['privacy:metadata:local_xpstore_gastos:itemtype'] = '引き換えられたアイテムの種類。';
$string['privacy:metadata:local_xpstore_gastos:timecreated'] = '引き換えが行われた時間。';
$string['privacy:metadata:local_xpstore_gastos:userid'] = '引き換えを行ったユーザー。';
