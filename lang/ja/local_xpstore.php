...
$string['searchfilters_help'] = '3つの基準を使用してレポートをフィルタリングできます:<br><br><b>参加者:</b> 学生の名または姓で検索します。<br><b>活動:</b> Moodle活動の名前または報酬に割り当てられたカスタムラベルで検索します。<br><b>タイプ:</b> 報酬タイプ (例: 特別、ボーナスなど) で検索します。';
$string['searchtype'] = '検索 (タイプ)...';
$string['searchuser'] = '検索 (参加者)...';
...
$string['type_g'] = 'ボーナス';
$string['type_help'] = '特典のタイプを選択してください:<br><br><b>追加の受験:</b> 小テストで機能します。<br><b>延長:</b> 課題でのみ機能します。<br><b>フォーラム (レガシー):</b> 終了日時後の投稿を許可します。<br><b>ボーナス:</b> 評定表に直接追加のポイントを追加します。<br><b>特別:</b> 非表示のコンテンツのVIPグループのロックを解除します。<br><b>ロック解除:</b> ストアによって制限されている特定のアクティビティのロックを解除します (XP Store Availability プラグインが必要です)。';
$string['type_q'] = '追加の受験';
$string['type_s'] = '特別';
