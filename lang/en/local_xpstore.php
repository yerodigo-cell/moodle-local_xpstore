...
$string['label'] = 'Label';
$string['label_help'] = 'If you select the <b>Special</b> type, this label must exactly match the name of the group you created in the course.';
$string['limit'] = 'Limit';
...
$string['type_g'] = 'Bonus';
$string['type_help'] = 'Select the type of benefit:<br><br><b>Extra Attempt:</b> Works with Quizzes.<br><b>24h Extension:</b> Works only with Assignments.<br><b>Bonus:</b> Adds extra points directly to the gradebook.<br><b>Special:</b> Unlocks hidden content or VIP groups.';
