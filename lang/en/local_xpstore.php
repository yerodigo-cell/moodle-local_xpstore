...
$string['type_g'] = 'Bonus';
$string['type_help'] = 'Select the type of benefit:<br><br><b>Extra Attempt:</b> Works with Quizzes.<br><b>Extension:</b> Works only with Assignments.<br><b>Forum (Legacy):</b> Allows posting after the cut-off date.<br><b>Bonus:</b> Adds extra points directly to the gradebook.<br><b>Special:</b> Unlocks hidden content or VIP groups.';
