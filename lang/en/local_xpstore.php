...
$string['chooserequirement'] = 'Choose requirement';
...
$string['confirmresetuser'] = 'Are you sure you want to clear all history for this user?';
...
$string['remainingbalance'] = 'Balance: {$a} XP';
$string['reportsubtitle'] = 'Individual tracking of XP benefits';
$string['reporttitle'] = 'Redemption Report';
$string['requirement'] = 'Requirement';
$string['requirement_help'] = 'Select an activity that the student must complete before they can redeem this reward. The reward will be locked until the activity meets its completion conditions.';
$string['requires'] = 'must be complete';
$string['requires_short'] = 'Requires';
$string['resetcolors'] = 'Reset to default';
$string['resetcycle'] = 'Reset Cycle';
$string['resethistory'] = 'Clear redemption history';
$string['resetuser'] = 'Reset User';
...
$string['searchfilters_help'] = 'You can filter the report using three criteria:<br><br><b>Participant:</b> Searches by the first or last name of the student.<br><b>Activity:</b> Searches by the name of the Moodle activity or the custom label assigned to the reward.<br><b>Type:</b> Searches by the reward type (e.g. Special, Bonus, etc).';
$string['searchtype'] = 'Search (Type)...';
$string['searchuser'] = 'Search (Participant)...';
...
$string['showrestricted'] = 'Show "Restricted" label';
...
$string['topactivities'] = 'Activities with most purchases';
$string['toprewardsbypurchases'] = 'Most purchased rewards';
$string['toprewardsbyxp'] = 'Rewards with most XP spent';
...
$string['type'] = 'Type';
$string['type_a'] = 'Extension';
$string['type_f'] = 'Forum (Legacy)';
$string['type_g'] = 'Bonus';
$string['type_help'] = 'Select the type of benefit:<br><br><b>Extra Attempt:</b> Works with Quizzes.<br><b>Extension:</b> Works only with Assignments.<br><b>Forum (Legacy):</b> Allows posting after the cut-off date.<br><b>Bonus:</b> Adds extra points directly to the gradebook.<br><b>Special:</b> Unlocks hidden content in VIP groups.<br><b>Unlock:</b> Unlocks specific activities restricted by the store (requires XP Store Availability plugin).';
...
$string['user'] = 'User';
$string['userreset'] = 'User data reset successfully.';
