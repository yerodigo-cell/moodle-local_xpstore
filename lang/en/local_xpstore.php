...
$string['menuvisibility_help'] = 'Enables or disables the direct access link to the store in the course navigation menu for students.';
...
$string['primarycolor'] = 'Primary Color (Cards & Icons)';
...
$string['quiz_id'] = 'Product List';
$string['quiz_id_desc'] = '⚠️ <strong>RECOMMENDATION:</strong> Do not edit this box manually. Please use the "XP Store Config" panel inside any course to easily add or remove rewards.<br><br><small><em>Internal format: TYPEID:COST:NAME. Example: S999:1500:VIP</em></small>';
...
$string['showinmenu'] = 'Mostrar en el menú del curso';
$string['showinmenu_desc'] = 'Si se marca, los estudiantes verán el acceso directo a la tienda en el menú de navegación lateral.';
$string['soldout'] = 'Sold out';
$string['specialcontent'] = 'Reward';
...
$string['tiendagamificada:manage'] = 'Manage the XP Store';
$string['tiendaxp'] = 'XP Store';
$string['type'] = 'Type';
$string['type_a'] = '24h Extension';
$string['type_f'] = 'Forum (Legacy)';
$string['type_g'] = 'Bonus';
$string['type_help'] = 'Select the type of benefit:<br><br><b>Extra Attempt:</b> Works with Quizzes.<br><b>24h Extension:</b> Works only with Assignments.<br><b>Bonus:</b> Adds extra points directly to the gradebook.<br><b>Reward:</b> Unlocks hidden content or VIP groups.';
$string['type_q'] = 'Extra Attempt';
$string['type_s'] = 'Reward';
...
$string['widget_panel_title'] = 'Embed Store or Categories (Widgets)';
