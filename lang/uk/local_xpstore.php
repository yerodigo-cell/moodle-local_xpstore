...
$string['analyticssubtitle'] = 'Показники продуктивності та використання магазину';
...
$string['engagementrate'] = 'Рівень залученості';
...
$string['mockup_sampleitem'] = 'Зразок товару';
$string['mockup_shortdesc'] = 'Короткий опис';
$string['mockup_storebanner'] = 'Банер магазину';
$string['mockup_storecard'] = 'Картка магазину';
$string['mockup_widget'] = 'Окремий віджет';
...
$string['topactivities'] = 'Активності з найбільшою кількістю покупок';
$string['toprewardsbypurchases'] = 'Нагороди, які купують найчастіше';
$string['toprewardsbyxp'] = 'Нагороди з найбільшими витратами XP';
$string['totalpurchases'] = 'Всього покупок';
$string['totalspent'] = 'Всього витрачено: {$a} XP';
$string['totalstudents'] = 'Залучені студенти';
$string['totalxp'] = 'Всього витрачено XP';
$string['type'] = 'Тип';
$string['type_a'] = 'Подовження на 24 год';
$string['type_f'] = 'Форум (Класичний)';
$string['type_g'] = 'Бонус';
$string['type_help'] = 'Виберіть тип переваги:<br><br><b>Додаткова спроба:</b> Працює з тестами.<br><b>Подовження:</b> Працює лише із завданнями.<br><b>Форум (Класичний):</b> Дозволяє публікувати після дати закриття.<br><b>Бонус:</b> Додає додаткові бали безпосередньо в журнал оцінок.<br><b>Спеціальний:</b> Розблоковує прихований вміст у VIP-групах.<br><b>Розблокувати:</b> Розблоковує певні діяльності, обмежені магазином (потрібен плагін XP Store Availability).';
$string['type_q'] = 'Додаткова спроба';
$string['type_s'] = 'Спеціальний';
$string['type_u'] = 'Unlock';
$string['update'] = 'Оновити';
$string['user'] = 'Користувач';
$string['viewanalytics'] = 'Переглянути аналітику';
$string['viewaudit'] = 'Переглянути журнал аудиту';
