...
$string['analyticssubtitle'] = 'Mağaza performansı ve kullanım metrikleri';
...
$string['edit'] = 'Düzenle';
$string['engagementrate'] = 'Etkileşim Oranı';
...
$string['mockup_shortdesc'] = 'Kısa açıklama';
$string['mockup_storebanner'] = 'Mağaza Afişi';
$string['mockup_storecard'] = 'Mağaza Kartı';
$string['mockup_widget'] = 'Bireysel Widget';
...
$string['points'] = 'Puan';
$string['predefinedpalettes'] = 'Önceden Tanımlanmış Paletler';
$string['preview'] = 'Önizleme';
$string['primarycolor'] = 'Ana Renk';
...
$string['topactivities'] = 'En çok satın alınan aktiviteler';
$string['toprewardsbypurchases'] = 'En çok satın alınan ödüller';
$string['toprewardsbyxp'] = 'En çok XP harcanan ödüller';
$string['totalpurchases'] = 'Toplam Satın Almalar';
$string['totalspent'] = 'Toplam harcanan: {$a} XP';
$string['totalstudents'] = 'Etkileşimli Öğrenciler';
$string['totalxp'] = 'Harcanan Toplam XP';
$string['type'] = 'Tür';
$string['type_a'] = '24s Uzatma';
$string['type_f'] = 'Forum (Klasik)';
$string['type_g'] = 'Bonus';
$string['type_help'] = 'Avantaj türünü seçin:<br><br><b>Ekstra Deneme:</b> Sınavlar ile çalışır.<br><b>Uzatma:</b> Sadece Ödevlerle çalışır.<br><b>Forum (Klasik):</b> Kapanış tarihinden sonra gönderi yapılmasına izin verir.<br><b>Bonus:</b> Doğrudan not defterine ekstra puan ekler.<br><b>Özel:</b> Gizli içeriğin VIP gruplarında kilidini açar.<br><b>Kilidi Aç:</b> Mağaza tarafından kısıtlanan belirli etkinliklerin kilidini açar (XP Store Availability eklentisini gerektirir).';
...
$string['viewaudit'] = 'Denetim Günlüğünü Görüntüle';
