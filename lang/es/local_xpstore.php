...
$string['type_help'] = 'Selecciona el tipo de beneficio:<br><br><b>Intento Extra:</b> Funciona con los cuestionarios (Quizzes).<br><b>Extensión:</b> Funciona solo con las tareas (Assignments).<br><b>Foro (Histórico):</b> Permite publicar después de la fecha de cierre.<br><b>Bonus (Nota):</b> Añade puntos extra directos a la calificación.<br><b>Especial:</b> Habilita el acceso a material oculto o grupos VIP.<br><b>Desbloquear:</b> Desbloquea actividades específicas restringidas por la tienda (requiere el plugin XP Store Availability).';
