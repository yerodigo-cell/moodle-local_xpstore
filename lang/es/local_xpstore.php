...
$string['label_help'] = 'Si seleccionas el tipo <b>Especial</b>, este label (etiqueta) debe tener exactamente el mismo nombre del grupo que creaste en el curso.';
$string['limit'] = 'Límite';
...
$string['type_help'] = 'Selecciona el tipo de beneficio:<br><br><b>Intento Extra:</b> Funciona con los cuestionarios (Quizzes).<br><b>Plazo 24h:</b> Funciona solo con las tareas (Assignments).<br><b>Bonus (Nota):</b> Añade puntos extra directos a la calificación.<br><b>Especial:</b> Habilita el acceso a material oculto o grupos VIP.';
