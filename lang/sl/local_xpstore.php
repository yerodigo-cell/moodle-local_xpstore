...
$string['type_g'] = 'Bonus';
$string['type_help'] = 'Izberite vrsto ugodnosti:<br><br><b>Dodatni poskus:</b> Deluje s kvizi.<br><b>Podaljšanje:</b> Deluje samo z nalogami.<br><b>Forum (Klasično):</b> Omogoča objavljanje po končnem datumu.<br><b>Bonus:</b> Dodatne točke doda neposredno v redovalnico.<br><b>Posebno:</b> Oklene skrito vsebino v VIP skupinah.<br><b>Odkleni:</b> Oklene določene dejavnosti, ki jih omejuje trgovina (zahteva vtičnik XP Store Availability).';
