...
$string['analytics'] = 'Analytiikka';
$string['analyticssubtitle'] = 'Kaupan suorituskyky ja käyttömetriikat';
...
$string['edit'] = 'Muokkaa';
$string['engagementrate'] = 'Osallistumisaste';
...
$string['mockup_sampleitem'] = 'Esimerkkituote';
$string['mockup_shortdesc'] = 'Lyhyt kuvaus';
$string['mockup_storebanner'] = 'Kaupan banneri';
$string['mockup_storecard'] = 'Kaupan kortti';
$string['mockup_widget'] = 'Yksittäinen widget';
...
$string['searchactivity'] = 'Haku (Aktiviteetti)...';
$string['searchfilters'] = 'Hakusuodattimet';
$string['searchfilters_help'] = 'Voit suodattaa raportin kolmen kriteerin perusteella:<br><br><b>Osallistuja:</b> Etsii opiskelijan etu- tai sukunimen perusteella.<br><b>Aktiviteetti:</b> Etsii Moodle-aktiviteetin nimen tai palkinnolle määritetyn mukautetun tunnisteen perusteella.<br><b>Tyyppi:</b> Etsii palkintotyypin perusteella (esim. Erikois, Bonus, jne.).';
$string['searchtype'] = 'Haku (Tyyppi)...';
$string['searchuser'] = 'Haku (Osallistuja)...';
$string['secondarycolor'] = 'Toissijainen väri';
...
$string['topactivities'] = 'Aktiviteetit, joissa eniten ostoja';
$string['toprewardsbypurchases'] = 'Ostetuimmat palkinnot';
$string['toprewardsbyxp'] = 'Palkinnot, joihin on käytetty eniten XP:tä';
$string['totalpurchases'] = 'Ostokset yhteensä';
$string['totalspent'] = 'Yhteensä käytetty: {$a} XP';
$string['totalstudents'] = 'Osallistuvat opiskelijat';
$string['totalxp'] = 'Käytetty XP yhteensä';
$string['type'] = 'Tyyppi';
$string['type_a'] = 'Pidennys';
$string['type_f'] = 'Foorumi (Klassinen)';
$string['type_g'] = 'Bonus';
$string['type_help'] = 'Valitse edun tyyppi:<br><br><b>Ylimääräinen yritys:</b> Toimii tenttien kanssa.<br><b>Pidennys:</b> Toimii vain tehtävien kanssa.<br><b>Foorumi (Klassinen):</b> Sallii julkaisemisen sulkemispäivän jälkeen.<br><b>Bonus:</b> Lisää lisäpisteitä suoraan arviointikirjaan.<br><b>Erityinen:</b> Avaa piilotetun sisällön VIP-ryhmissä.<br><b>Avaa lukitus:</b> Avaa kaupan rajoittamia tiettyjä aktiviteetteja (edellyttää XP Store Availability -liitännäistä).';
...
$string['viewaudit'] = 'Näytä tarkastusloki';
