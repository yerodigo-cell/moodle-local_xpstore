...
$string['topactivities'] = 'Jarduera nagusiak (erosketen arabera)';
$string['toprewardsbypurchases'] = 'Sari nagusiak (erosketen arabera)';
$string['toprewardsbyxp'] = 'Sari nagusiak (XPren arabera)';
