...
$string['type'] = 'Mota';
$string['type_a'] = 'Luzapena';
$string['type_f'] = 'Foroa (Klasikoa)';
$string['type_g'] = 'Saria';
$string['type_help'] = 'Hautatu onura mota:<br><br><b>Saiakera Estra:</b> Galdetegiekin funtzionatzen du.<br><b>Luzapena:</b> Zereginekin soilik funtzionatzen du.<br><b>Foroa (Klasikoa):</b> Ixteko dataren ostean argitaratzea ahalbidetzen du.<br><b>Saria:</b> Puntu gehigarriak gehitzen ditu zuzenean kalifikazio-liburuan.<br><b>Berezia:</b> Ezkutuko edukia VIP taldeetan desblokeatzen ditu.<br><b>Desblokeatu:</b> Dendak mugatutako jarduera zehatzak desblokeatzen ditu (XP Store Availability plugina behar du).';
