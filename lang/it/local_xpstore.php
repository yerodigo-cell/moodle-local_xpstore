...
$string['type'] = 'Tipo';
$string['type_a'] = 'Estensione';
$string['type_f'] = 'Forum (Classico)';
$string['type_g'] = 'Bonus';
$string['type_help'] = 'Seleziona il tipo di vantaggio:<br><br><b>Tentativo Extra:</b> Funziona con i Quiz.<br><b>Estensione:</b> Funziona solo con i Compiti.<br><b>Forum (Classico):</b> Consente di pubblicare dopo la data di chiusura.<br><b>Bonus:</b> Aggiunge punti extra direttamente al registro valutatore.<br><b>Speciale:</b> Sblocca contenuti nascosti nei gruppi VIP.<br><b>Sblocca:</b> Sblocca attività specifiche limitate dal negozio (richiede il plugin XP Store Availability).';
