...
$string['topactivities'] = 'Attività principali (per acquisti)';
$string['toprewardsbypurchases'] = 'Premi principali (per acquisti)';
$string['toprewardsbyxp'] = 'Premi principali (per XP)';
