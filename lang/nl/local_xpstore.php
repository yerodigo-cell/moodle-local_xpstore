...
$string['type_g'] = 'Bonus';
$string['type_help'] = 'Selecteer het type voordeel:<br><br><b>Extra Poging:</b> Werkt met Quizzen.<br><b>Verlenging:</b> Werkt alleen met Opdrachten.<br><b>Forum (Klassiek):</b> Maakt plaatsen na de sluitingsdatum mogelijk.<br><b>Bonus:</b> Voegt direct extra punten toe aan de cijferlijst.<br><b>Speciaal:</b> Ontgrendelt verborgen inhoud in VIP-groepen.<br><b>Ontgrendelen:</b> Ontgrendelt specifieke activiteiten die door de winkel zijn beperkt (vereist de XP Store Availability-plug-in).';
