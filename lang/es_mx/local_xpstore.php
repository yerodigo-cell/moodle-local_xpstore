...
$string['primarycolor'] = 'Color Primario (Tarjetas e Íconos)';
$string['privacy:metadata:local_xpstore_gastos'] = 'Almacena información sobre los canjes de los usuarios en la Tienda XP.';
...
$string['privacy:metadata:local_xpstore_gastos:itemtype'] = 'El tipo del artículo canjeado.';
$string['privacy:metadata:local_xpstore_gastos:timecreated'] = 'El momento en que ocurrió el canje.';
...
$string['toprewardsbypurchases'] = 'Recompensas Principales (por canjes)';
$string['toprewardsbyxp'] = 'Recompensas Principales (por XP gastados)';
$string['totalstudents'] = 'Estudiantes Involucrados';
$string['totalxp'] = 'Total XP Gastados';
$string['totalpurchases'] = 'Canjes Totales';
