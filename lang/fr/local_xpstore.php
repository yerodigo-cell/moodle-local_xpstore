...
$string['topactivities'] = 'Top Activités (par achats)';
$string['toprewardsbypurchases'] = 'Top Récompenses (par achats)';
$string['toprewardsbyxp'] = 'Top Récompenses (par XP dépensé)';
