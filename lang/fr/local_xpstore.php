...
$string['analytics'] = 'Analytiques';
$string['analyticssubtitle'] = 'Performances de la boutique et métriques d\'utilisation';
...
$string['engagementrate'] = 'Taux d\'engagement';
...
$string['mockup_sampleitem'] = 'Exemple d\'article';
$string['mockup_shortdesc'] = 'Courte description';
$string['mockup_storebanner'] = 'Bannière de la boutique';
$string['mockup_storecard'] = 'Carte de la boutique';
$string['mockup_widget'] = 'Widget individuel';
...
$string['predefinedpalettes'] = 'Palettes prédéfinies';
...
$string['topactivities'] = 'Activités avec le plus d\'achats';
$string['toprewardsbypurchases'] = 'Récompenses les plus achetées';
$string['toprewardsbyxp'] = 'Récompenses avec le plus d\'XP dépensé';
$string['totalpurchases'] = 'Total des achats';
$string['totalspent'] = 'Total dépensé : {$a} XP';
$string['totalstudents'] = 'Étudiants engagés';
$string['totalxp'] = 'Total XP dépensé';
$string['type'] = 'Type';
$string['type_a'] = 'Extension';
$string['type_f'] = 'Forum (Ancien)';
$string['type_g'] = 'Bonus';
$string['type_help'] = 'Sélectionnez le type d\'avantage :<br><br><b>Tentative supplémentaire :</b> Fonctionne avec les Quiz.<br><b>Extension :</b> Fonctionne uniquement avec les Devoirs.<br><b>Forum (Ancien) :</b> Permet de publier après la date limite.<br><b>Bonus :</b> Ajoute des points supplémentaires directement dans le carnet de notes.<br><b>Spécial :</b> Débloque du contenu masqué dans des groupes VIP.<br><b>Débloquer :</b> Débloque des activités spécifiques restreintes par la boutique (nécessite le plugin XP Store Availability).';
$string['type_q'] = 'Tentative supp.';
$string['type_s'] = 'Spécial';
$string['type_u'] = 'Unlock';
$string['update'] = 'Mettre à jour';
$string['user'] = 'Utilisateur';
$string['viewanalytics'] = 'Voir les analyses';
$string['viewaudit'] = 'Voir le journal d\'audit';
