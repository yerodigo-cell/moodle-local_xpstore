...
$string['points'] = 'Баллы';
$string['primarycolor'] = 'Основной цвет (карточки и иконки)';
$string['privacy:metadata:local_xpstore_gastos'] = 'Хранит информацию об обменах пользователей в XP Store.';
$string['privacy:metadata:local_xpstore_gastos:amount'] = 'Стоимость товара в XP.';
$string['privacy:metadata:local_xpstore_gastos:itemid'] = 'ID модуля курса, к которому был применен обмен.';
$string['privacy:metadata:local_xpstore_gastos:itemtype'] = 'Тип обменянного товара.';
$string['privacy:metadata:local_xpstore_gastos:timecreated'] = 'Время обмена.';
$string['privacy:metadata:local_xpstore_gastos:userid'] = 'Пользователь, совершивший обмен.';
