...
$string['searchactivity'] = 'Поиск (Элемент курса)...';
$string['searchfilters'] = 'Фильтры поиска';
$string['searchfilters_help'] = 'Вы можете отфильтровать отчет, используя три критерия:<br><br><b>Участник:</b> Поиск по имени или фамилии студента.<br><b>Элемент курса:</b> Поиск по названию элемента курса Moodle или пользовательской метке, назначенной для награды.<br><b>Тип:</b> Поиск по типу награды (например, Особая, Бонус и т. д.).';
$string['searchtype'] = 'Поиск (Тип)...';
$string['searchuser'] = 'Поиск (Участник)...';
...
$string['type_g'] = 'Бонус';
$string['type_help'] = 'Выберите тип преимущества:<br><br><b>Дополнительная попытка:</b> Работает с тестами.<br><b>Продление:</b> Работает только с заданиями.<br><b>Форум (Классический):</b> Позволяет публиковать сообщения после закрытия.<br><b>Бонус:</b> Добавляет дополнительные баллы прямо в журнал оценок.<br><b>Специальный:</b> Разблокирует скрытый контент в VIP-группах.<br><b>Разблокировать:</b> Разблокирует определенные активности, ограниченные магазином (требуется плагин XP Store Availability).';
