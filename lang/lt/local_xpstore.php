...
$string['topactivities'] = 'Populiariausios veiklos (pagal pirkimus)';
$string['toprewardsbypurchases'] = 'Populiariausi apdovanojimai (pagal pirkimus)';
$string['toprewardsbyxp'] = 'Populiariausi apdovanojimai (pagal išleistą XP)';
