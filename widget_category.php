...
<div class="tienda-wrapper">
    <div class="wallet-header">
        <div class="text-uppercase small mb-1" style="letter-spacing: 1px; font-weight: bold; opacity: 0.9;">
            <?php echo get_string('saldo', 'local_xpstore'); ?>
        </div>
        <div class="xp-balance"><?php echo $saldo; ?> XP</div>
        <a href="<?php echo $historyurl; ?>" target="_top" class="btn-history">
    ...
    if (empty($categorias_tienda)) {
        ...
        foreach ($categorias_tienda as $nombre_seccion => $productos) {
            ...
            foreach ($productos as $p) {
                ...
                <div class="p-card">
                    <div>
                        <div style="font-size: 20px; color: var(--ci); margin-bottom: 8px;">
                    ...
                    <div>
                        <div class="font-weight-bold text-primary m-0" style="font-size: 1.1rem;">
                            <?php echo $costo; ?> XP
                        </div>
