...
Administrators or editing teachers can access the configuration panel directly from the store's interface or via the following URL:

**Path:** `yoursite.com/local/xpstore/config.php?id=COURSE_ID`

From this panel you can:

1. Build the product catalog configuration string (defining costs, limits, and categories). 
2. Assign icons to created categories.
3. **Automatically generate Iframe codes** for widgets to instantly integrate them into the course.
4. Define the UI color palette.
