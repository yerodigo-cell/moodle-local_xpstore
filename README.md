...
* **Auditoría y Reportes:** Panel completo para profesores con el historial detallado de canjes por estudiante, avatares y enlaces directos a las actividades o al libro de calificaciones.
...
Una vez instalado, los administradores o profesores con permisos de edición pueden configurar la tienda accediendo al panel de administración exclusivo del curso:
...
```html
<a href="https://tusitio.com/local/xpstore/index.php?id=ID_CURSO">
    Ir a la Tienda
</a>
```
...
```html
<iframe src="https://tusitio.com/local/xpstore/widget_category.php?id=ID_CURSO&cat=NombreCategoria" width="100%" height="600" frameborder="0"></iframe>
```
